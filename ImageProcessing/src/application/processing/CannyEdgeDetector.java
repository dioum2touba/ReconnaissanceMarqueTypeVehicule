...
public class CannyEdgeDetector {
        ...
        {
           // if ( args.length < 1 ) System.out.println("needs a file to process");
        
           String filename = "D:\\Memoire\\EdgeDetection\\edgesTmp362616.png";

           // Image img = new Image(new File(filename).toURI().toString());
           /*  ImageIcon icon = new ImageIcon(img);
            Image image = icon.getImage(); */
            // Create empty BufferedImage, sized to Image
            BufferedImage imag = loadImage(filename);
            BufferedImage frame =
                new BufferedImage(
                        imag.getWidth(null),
                        imag.getHeight(null),
            ...
            JLabel label = new JLabel(new ImageIcon(edges));
